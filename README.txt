...
UDT version 4 is free software under BSD License. 
See ./LICENSE.txt.
...
Example programs 
./doc:     
UDT documentation (HTML)
./win:     

Visual C++ project files for the Windows version of UDT 
...
Questions? 
please post to the UDT project forum:
